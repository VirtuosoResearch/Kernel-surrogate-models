...
class Hessian(object):
    def __init__(self, model, dataloader, loss_fn,  m = 100, sigma = 1e-5**0.5, ckpt_iteration= 0, train_data = [], block_size = None, batch_size = None, num_v = 1, ctx =nullcontext(), use_minibatch = True, gradient_accumulation_steps = 1, device = 'cuda',  sample_layer = ['layer2'], ddp = False, comment = 'test'):
        self.model = model
        ...
        self.device = device
        self.sample_layer = ['layers.0.mlp.2.weight']
        self.ddp = ddp
        self.num_v = num_v
        self.num_bins = 1000
